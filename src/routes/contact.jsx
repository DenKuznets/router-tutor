    ...
    <div id="contact">
      ...
      <div>
        ...
        <div>
          ...
          <Form
            method="post"
            // destroy - относительная ссылка. Поскольку форма отрисовывается по пути 'contact/:contactId', то относительное действие destroy отправит ссылку по пути 'contact/:contactId/destroy'
            action="destroy"
            onSubmit={(event) => {
              if (
                !window.confirm(
